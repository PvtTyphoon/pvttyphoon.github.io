...
Customized for the Deathconsciousness album by Have A Nice Life
...
// Album timeline data for carousel
        ...
        const albumTimelineData = [
            {
                ...
                image: 'images/073550af7afcdd23148f4dad5d46ca11.webp'
            },
            {
                id: 2,
                ...
                image: 'images/1facf3bcb16a1640671d6757fa4d98c2.webp'
            },
            {
                id: 3,
                ...
                image: 'images/2ffef355a49c26cc11dcf1bab3b1b95a.webp'
            },
            {
                id: 4,
                ...
                image: 'images/34e1109848d2419fb22645d2e9ab16e4.webp'
            },
            {
                id: 5,
                ...
                image: 'images/661f3c1066324fa3bc02e6989c08dc6c.webp'
            },
            {
                id: 6,
                title: 'Word Spreads',
                ...
                image: 'images/8ef6af414897da3656f8fabfd8fc71a4.webp'
            },
            {
                id: 7,
                ...
                image: 'images/91d8e7c7ff754797bf24190cbe6cc2d0.webp'
            }
        ];

        // Musical elements data
        const musicalElementsData = [
            { name: 'Wall of Sound', icon: '🌊', level: 98, category: 'shoegaze' },
            { name: 'Distortion', icon: '⚡', level: 95, category: 'shoegaze' },
            { name: 'Reverb', icon: '🌫️', level: 92, category: 'shoegaze' },
            { name: 'Dark Ambience', icon: '🌑', level: 94, category: 'ambient' },
            { name: 'Drone', icon: '🌀', level: 88, category: 'ambient' },
            { name: 'Bass Lines', icon: '🎸', level: 90, category: 'postpunk' },
            { name: 'Drum Programming', icon: '🥁', level: 85, category: 'postpunk' },
            { name: 'Field Recordings', icon: '📼', level: 87, category: 'postpunk' },
            { name: 'Noise Collage', icon: '📻', level: 82, category: 'experimental' },
            { name: 'Tape Saturation', icon: '📟', level: 91, category: 'experimental' },
            { name: 'Layered Vocals', icon: '🎤', level: 89, category: 'shoegaze' },
            { name: 'Dynamic Range', icon: '📊', level: 93, category: 'postpunk' }
        ];
        ...
        // Initialize sound elements grid
        function initSoundGrid() {
            const soundGrid = document.getElementById('soundGrid');
            const categoryTabs = document.querySelectorAll('.category-tab');
            
            function displaySoundElements(category = 'all') {
                soundGrid.innerHTML = '';
                ...
                filteredSkills.forEach((skill, index) => {
                    ...
                    hexagon.className = 'sound-element';
                    hexagon.style.animationDelay = `${index * 0.1}s`;
                    
                    hexagon.innerHTML = `
                        <div class="hexagon-inner">
                            <div class="hexagon-content">
                                <div class="sound-icon">${skill.icon}</div>
                                <div class="sound-name">${skill.name}</div>
                                <div class="sound-level">
                                    <div class="sound-level-fill" style="width: ${skill.level}%"></div>
                                </div>
                                <div class="sound-percentage">${skill.level}%</div>
                            </div>
                        </div>
                    `;
                    
                    soundGrid.appendChild(hexagon);
                });
            }
            ...
            categoryTabs.forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    displaySoundElements(tab.dataset.category);
                });
            });
            
            displaySoundElements();
        }
        ...
        function updateActiveNav() {
            ...
            const isHome = pathname === '/' || pathname.endsWith('/index.html') || pathname.endsWith('index.html');
            const isAbout = pathname.includes('/about') || pathname.endsWith('/about/') || pathname.endsWith('about/index.html');
            ...
            navLinks.forEach(link => {
                ...
                if (isHome && (href === '/' || href === 'index.html' || href === 'home.html' || href === '#home')) {
                    link.classList.add('active');
                } else if (isAbout && (href === '/about' || href === 'about.html' || href === '#about')) {
                    link.classList.add('active');
                }
            });
        }
        ...
        if (tracksSection) {
            observer.observe(tracksSection);
        }
